...
ا-`scp` مخفف **Secure Copy** است و برای **انتقال فایل و دایرکتوری بین سیستم‌ها از طریق SSH** استفاده می‌شود. یعنی همان SSH، ولی به‌جای اجرای Shell، فایل را جابه‌جا می‌کند.
