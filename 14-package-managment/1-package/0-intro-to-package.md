...
ا-**Package (پکیج)** یک مجموعه‌ی آماده از فایل‌هاست که برای **نصب یک نرم‌افزار یا یک قابلیت در Linux** بسته‌بندی شده است.
...
```
Package = مجموعه‌ای از فایل‌ها + اطلاعات لازم
          برای نصب و مدیریت یک نرم‌افزار/قابلیت
          در Linux
```
