...
ا-`ps` مخفف **Process Status** است و برای دیدن اطلاعات Processهای در حال اجرا استفاده می‌شود.
...
ا-`options` مشخص می‌کنند **چه Processهایی و با چه اطلاعاتی** نمایش داده شوند.
