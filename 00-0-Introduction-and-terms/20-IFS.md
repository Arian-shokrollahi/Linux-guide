...
IFS یک **متغیر داخلی Bash** است که مشخص می‌کند Shell هنگام **Word Splitting** بر اساس چه کاراکترهایی متن را به چند قسمت تقسیم کند.

به زبان ساده:

> IFS به Bash می‌گوید "کجاها باید یک مقدار را جدا کنم؟"
